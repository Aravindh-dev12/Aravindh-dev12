...
Hi, I'm **Aravindhan**. I build AI systems and full-stack products with a focus on practical, shippable software.

- Building **LLM, RAG, agentic and voice-AI systems**
- Working across **Next.js, React, Vue, FastAPI, PostgreSQL, Redis and Flutter**
- Exploring **neuro-symbolic reasoning, local/open-weight LLMs, retrieval and inference**
- Interested in developer tools, experimental interfaces and intelligent products
- Motto: **Build in the shadows. Ship in the light.**
...
<img src="https://skillicons.dev/icons?i=python,js,ts,react,nextjs,vue,nodejs,fastapi,flutter,dart,postgres,redis,docker,git,github,vscode,html,css&perline=10" alt="technology stack">
...
<img src="https://github-readme-activity-graph.vercel.app/graph?username=Aravindh-dev12&bg_color=0d1117&color=39d353&line=39d353&point=ffffff&area=true&hide_border=true" width="95%" alt="GitHub contribution activity graph">
...
<img src="./assets/languages.svg" height="190" alt="Most used languages">
