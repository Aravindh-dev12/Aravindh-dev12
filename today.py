...
def bat_swarm(theme):
    # 16 bats. Fly once when the SVG loads, then disappear until refresh.
    flights = [
        ("0s", "2.4s", "M20,72 C180,18 365,22 545,82 C725,142 875,112 970,42"),
        ("0.06s", "2.55s", "M10,115 C155,42 330,40 510,98 C700,160 850,136 978,66"),
        ("0.12s", "2.7s", "M18,160 C170,80 345,64 525,126 C700,187 865,160 972,92"),
        ("0.18s", "2.35s", "M16,215 C170,130 345,118 525,180 C705,242 865,210 975,135"),
        ("0.24s", "2.5s", "M20,265 C175,182 350,170 535,228 C720,286 875,257 972,185"),
        ("0.30s", "2.65s", "M18,318 C175,238 352,224 540,282 C725,340 875,310 972,235"),
        ("0.36s", "2.8s", "M18,368 C180,292 355,282 545,340 C730,395 878,365 970,292"),
        ("0.42s", "2.45s", "M20,425 C190,350 370,342 555,395 C738,448 882,420 972,350"),
        ("0.48s", "2.3s", "M24,474 C205,406 395,400 580,449 C760,495 895,472 970,410"),
        ("0.54s", "2.6s", "M968,74 C800,25 635,45 475,112 C315,178 160,155 25,72"),
        ("0.60s", "2.4s", "M975,128 C805,70 640,92 478,158 C315,225 155,200 18,120"),
        ("0.66s", "2.2s", "M970,180 C805,120 645,142 480,205 C315,268 150,238 20,158"),
        ("0.72s", "2.55s", "M972,235 C810,180 650,198 485,260 C315,322 150,292 18,212"),
        ("0.78s", "2.9s", "M972,288 C810,230 650,246 485,307 C315,370 150,342 18,262"),
        ("0.84s", "2.45s", "M970,392 C805,334 645,350 480,411 C310,470 148,442 18,360"),
        ("0.90s", "2.65s", "M965,490 C800,438 635,444 475,486 C315,525 150,510 22,445"),
    ]

    pieces = [f'<g fill="{theme["ascii"]}" pointer-events="none">']
    for index, (begin, duration, path) in enumerate(flights):
        scale = 0.46 + (index % 5) * 0.055
        flap_duration = f"{0.34 + (index % 3) * 0.05:.2f}s"
        pieces.append(
            '<g opacity="0">'
            f'{realistic_bat(scale, flap_duration)}'
            f'<animate attributeName="opacity" values="0;0.30;0.25;0" '
